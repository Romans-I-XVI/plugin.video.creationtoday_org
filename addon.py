...
class Addon:
    ...
    def add_item(self, queries, infolabels, img='', fanart='', resolved=False, 
        ...
        if not resolved:
            ...
            play = resolved
	img = 'http://d1xhw6446dntwv.cloudfront.net/wordpress/wp-content/uploads/2013/08/S03E04small.jpg'
        liz=xbmcgui.ListItem('testing', iconImage=img, thumbnailImage=img)
        liz.setInfo( type="Video", infoLabels={ "Title": 'testing123' } )
